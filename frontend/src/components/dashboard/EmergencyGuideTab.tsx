    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-slate-100 pb-4">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-xl font-black text-slate-900 tracking-tight">RescueAI First Aid & Survival</h3>
            <p className="text-sm font-medium text-slate-500 mt-1">Official offline-ready protocols for critical situations.</p>
          </div>
        </div>
