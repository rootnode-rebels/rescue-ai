        ...
        <main className="flex-1 p-8">
          <header className="mb-8 border-b border-slate-800 pb-4">
            ...
            <p className="text-sm text-slate-400 mt-1">
              Official: <span className="font-semibold text-slate-200">{userProfile?.name}</span> ({userProfile?.email})
            </p>
          </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
              ...
              <p className="text-xs text-slate-400 mt-1">Active Roles: Citizen, Rescue Team, Authority</p>
            </div>
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
              <span className="text-2xl">🛡️</span>
              <h3 className="text-lg font-bold mt-2">Official Role</h3>
